...
$lang['successful_payment'] = "Successful Payment";
$lang['payment_settings'] = "Payment Settings";
// Payments
$lang['do_not_have_permission'] = "Info! You do not have permission to visit this page.";
$lang['success'] = "Success";
$lang['email_not_found'] = "Email not found";
$lang['paypal_note_1'] = "For security purpose all the setup configuration are in a config file, rather than stored in the database.";
$lang['paypal_note_2'] = "You will find all the configuration in application/config/paypal.php";
$lang['paypal_note_3'] = "In this file you have to update <b>\$config['business']</b> with your PayPal business email.";
$lang['paypal_note_4'] = "By default, the <b>\$config['sandbox']</b> is set to <b>TRUE</b>, which means you can test receiving donation.";
$lang['paypal_note_5'] = "But when you are done with testing, you should update the value from <b>TRUE</b> to <b>FALSE</b>";
$lang['paypal_note_6'] = "Now on the PayPal Settings, You have to take of two issues at this point.";
$lang['paypal_note_7'] = "1. Enable <b>Auto return</b> and <b>Payment data transfer</b> 2. Enable <b>Instant payment notifications (IPN)</b>";
$lang['paypal_note_8'] = "To enable Auto return and Payment data transfer, log into your PayPal business account and on the top-right find the <b>Account Settings</b> and click.";
$lang['paypal_note_9'] = "On the new page find <b>Website payments</b> under PRODUCTS & SERVICES, then click on <i>Update</i> button in the <b>Website preferences</b> row.";
$lang['paypal_note_10'] = "Under <b>Auto return</b> choose option <b>On</b> and it wil ask for a URL. This will be your URL: ";
$lang['paypal_note_11'] = "Now under <b>Payment data transfer</b> choose option <b>On</b> and that's it. You have completed step 1 successfully.";
$lang['paypal_note_12'] = "To enable <b>Instant payment notifications</b>, following from previous step, go to Account Settings and under Website payments, click <i>Update</i> on the <b>Instant payment notifications</b> row.";
$lang['paypal_note_13'] = "On the new page, click <i>Edit Settings</i> button and put this URL in the <b>Notification URL</b> input field: ";
$lang['paypal_note_14'] = "Choose <b>Receive IPN messages (Enabled)</b> under IPN Messages options, then click <i>Save</i> button. And with that PayPal Settings is completed, both steps.";
$lang['paypal_note_15'] = "PayPal form submitted: After putting <b>Amount</b> and <b>Donation Purpose</b>, hitting <i>Donate</i> button will take Alumnus automatically to PayPal.";
$lang['paypal_note_16'] = "Cancelled: At this point Alumnus will be able to cancel the donation if he/she wants to. The donation will be cancelled and redirected to Alumni website with cancel message.";
$lang['paypal_note_17'] = "IPN validated: This is an automated stage. If IPN is enabled, then PayPal will visit that URL after donation and save data to database table after validating via PayPal URL.";
$lang['paypal_note_18'] = "Success: This is the last step in which scenario everything goes fine and Alumnus was able to make a donation. It's data will also be save in the database.";
$lang['paypal_note_19'] = "You can start collecting donation via PayPal once you set up successfully.";
$lang['paypal_note_20'] = "Successful donatations will be saved twice on two separate tables.";
$lang['paypal_note_21'] = "On one table with the amount and the Alumnus name.";
$lang['paypal_note_22'] = "On another table with actual Transaction ID and all.";
$lang['paypal_note_23'] = "Instant payment notification need <b>live server</b> to work. Because PayPal is not going to recognize <b>http://localhost</b>";
$lang['add_transaction'] = "Add Transaction";
$lang['select_transaction'] = "Select transaction";
