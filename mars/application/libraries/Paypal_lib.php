...
{ 
    ...
    function __construct(){ 
        ...
        $this->ipn_paypal_url = ($sanbox == TRUE)?'https://ipnpb.sandbox.paypal.com/cgi-bin/webscr':'https://ipnpb.paypal.com/cgi-bin/webscr';
    ...
    function paypal_form($form_name='paypal_form'){ 
        ...
        $str .= form_open($this->paypal_url, array('name' => $form_name, 'method' => 'POST')) . "\n";
