...
<div id="content" class="content">
	...
	<div class="invoice print-body">
		...
		<div class="invoice-company text-inverse f-w-600">
			<?php echo form_open('invoice_pay_now'); ?>
			<span class="pull-right hidden-print">
				<button style="box-shadow: none; cursor: default" type="button" class="btn btn-sm btn-primary m-b-10 p-l-5" id="paid-button">Paid</button>
				<?php
					$due_amount_for_paypal = array(
						'type'  => 'hidden',
						'name'  => 'amount',
						'id'    => 'due-amount-for-paypal',
						'value' => 0
					);
					
					echo form_input($due_amount_for_paypal);
				?>
				<?php echo form_hidden('invoice_id', $invoice_id); ?>
				<?php if ($this->session->userdata('user_type') == 3): ?>
				<button title="Pay Now" type="submit" class="btn btn-sm m-b-10 r-l-5 hidden-print" id="paypal-button">
					<img src="https://www.paypalobjects.com/en_US/i/btn/btn_paynow_LG.gif" />
				</button>
				<?php endif; ?>
		...
		<div class="invoice-content">
				...
				<table class="table table-invoice">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center"><?php echo $tenant_paid['payment_method'] ?? 'N/A'; ?></td>
			...
			<div class="invoice-price">
				...
				<div class="invoice-price-right">
					...
					<span class="f-w-600" id="invoice-due-amount">
						<?php echo $currency; ?>
						<?php
						$this->db->select_sum('amount');
						$this->db->from('tenant_rent');
...
<script>
	(function() {
		var due_amount = (document.getElementById("invoice-due-amount").innerHTML).replace(/\s+/g, "").substring(1).replace(",","");
		document.getElementById("due-amount-for-paypal").value = due_amount;
		if (due_amount > 0) {
			document.getElementById("paid-button").classList.add("hide");
		} else {
			document.getElementById("paypal-button").classList.add("hide");
		}
	})();
</script>
