			...
			<div class="right-content">
				...
				<div class="login-content">
					...
					<div class="login-buttons m-t-20 m-b-40 p-b-40">
						<button type="submit" title="<?php echo $this->lang->line('sign_me_in'); ?>" class="btn btn-primary btn-block btn-lg m-b-10"><?php echo $this->lang->line('sign_me_in'); ?></button>
						<a class="pull-right" onclick="showAjaxModal('<?php echo base_url('modal/popup/modal_show_forgot_my_password'); ?>');" href="javascript:;">
							<?php echo $this->lang->line('forgot_my_password'); ?>
						</a>
						<?php if ($this->db->get_where('setting', array('setting_id' => 23))->row()->content == 'yes'): ?>
						<br>
						<a class="pull-right" href="<?php echo base_url('book_room'); ?>">
							<?php echo $this->lang->line('book_a_room'); ?>
						</a>
						<?php endif; ?>
					</div>
					<?php echo form_close(); ?>
					...
					<p class="text-center text-grey-darker">
						<strong>v6.04</strong> &copy; 2018 - <?php echo date('Y'); ?> <a href="<?php echo $this->db->get_where('setting', array('name' => 'copyright_url'))->row()->content; ?>" target="_blank"><?php echo $this->db->get_where('setting', array('name' => 'copyright'))->row()->content; ?></a>, All rights reserved.
					</p>
				</div>
				<!-- end login-content -->
			</div>
