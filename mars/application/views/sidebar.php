...
<div id="sidebar" class="sidebar" data-disable-slide-animation="true">
    ...
    <div data-scrollbar="true" data-height="100%">
        ...
        <ul class="nav">
            ...
            <?php endif; ?>
            <li class="has-sub <?php if ($page_name == 'board_member_settings' || $page_name == 'payment_method_settings' || $page_name == 'service_settings' || $page_name == 'currency_settings' || $page_name == 'website_settings' || $page_name == 'profession_settings' || $page_name == 'id_type_settings' || $page_name == 'payment_settings' || $page_name == 'profile_settings') echo 'active'; ?>">
                <a href="javascript:;">
                    <b class="caret"></b>
                    <i class="fa fa-cog"></i>
                ...
                <ul class="sub-menu">
                    ...
                    <li class="<?php if ($page_name == 'payment_settings') echo 'active'; ?>">
                        <a href="<?php echo base_url(); ?>payment_settings"><?php echo $this->lang->line('payment_settings'); ?></a>
                    </li>
                    <?php endif; ?>
